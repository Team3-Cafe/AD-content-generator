...
PLAN_ELEMENT_SCHEMA = {
    ...
    "properties": {
        ...
        "grid_row": {"type": "integer", "minimum": 0, "maximum": 4},
        "grid_col": {"type": "integer", "minimum": 0, "maximum": 4},
        "row_span": {"type": "integer", "minimum": 1, "maximum": 5},
        "col_span": {"type": "integer", "minimum": 1, "maximum": 5},
        "preferred_region": deepcopy(BBOX_SCHEMA),
        "alignment": {
            "type": "string",
